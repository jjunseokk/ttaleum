...
export default function Navigation() {
    ...
    return (
        <div className="navigation">
            ...
            <Image onClick={() => { routerNavigation('/') }} src={onItem === '/' ? onCategory : category} alt="category" />
            <Image onClick={() => { routerNavigation('/') }} src={onItem === '/' ? onCommunity : community} alt="community" />
            <Image onClick={() => { routerNavigation('/') }} src={onItem === '/' ? onUser : user} alt="user" />
        </div>
    )
}